...
const footerLinks = {
  ...
  Resources: ["Blog", "Guides", "Case Studies", "Templates"],
  ...
  return (
    <footer ref={ref} className="border-t border-zinc-800 bg-zinc-950">
      <div className="max-w-6xl mx-auto px-4 py-16">
        ...
        >
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-sm text-zinc-500 mb-4">
              AI-powered landing page audits in seconds.
            </p>
            {/* System Status */}
        ...
        >
          <p className="text-sm text-zinc-500">&copy; 2025 AuditMyLanding. All rights reserved.</p>
